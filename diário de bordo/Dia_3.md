...
Comecei a madrugada de domingo ainda lutando com o relay. Depois de toda a resistência do dia anterior, finalmente consegui fazer o Claude implementar direito. Mas aí veio uma surpresa desagradável: o login parou de funcionar de novo. É como se a IA desaprendesse as coisas. O mesmo problema que já tinha sido resolvido voltou a aparecer.

A solução? Mandei o Claude pesquisar a API de login novamente. Funcionou. É estranho ter que relembrar algo que já estava funcionando, mas pelo menos existe um workaround: fazer a IA buscar informação externa quando ela começa falhar. Me pergunto qual viabilidade de fazer isso em um projeto com muitas regras.
...
Não tenho ilusões: o código tem bugs, a arquitetura precisa de ajustes, e está longe de ser algo que eu colocaria em produção. Mas como prova de conceito? Impressionante. A velocidade de prototipagem é real.
